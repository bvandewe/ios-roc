...
from domain.models.command_output import CommandOutput
from domain.models.device import Device
from integration import IntegrationException


class CiscoCommandLineCollectorException(Exception):
    """Represents an error that occurs during the collection of a Cisco command line"""


class CiscoCommandLineCollectorBase(ABC):
    mediator: Mediator
